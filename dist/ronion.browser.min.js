...
b){a.splice(g,1);break}}},V:function(a,b,c,d){var g,f=this;var h=e(a,b);var k={b:a,f:b,i:c,B:d,s:null};var l=this.fire("encrypt",k).then(function(){var a=k.s;if(!(a instanceof Uint8Array)||a.length!==d.length+f.F)throw Error("Encryption failed");return a});this.a.has(h)?g=this.a.get(h):g=[c];g=function(a){var b,c;var d=[];var e=0;for(c=(b=g).length;e<c;++e){var f=b[e];d.push(f);if(a===f.join(","))break}return d}.call(this,c.join(","));g.reverse().forEach(function(c){return l=l.then(function(d){return f.N(a,
b,c,d)})});l["catch"](function(){});return l},U:function(a,b,c){var d,g=this;var f=e(a,b);this.a.has(f)?d=this.a.get(f):d=[a];var h=Promise.reject();var k={b:a,f:b,ea:null,s:c,B:null};d.forEach(function(d,e){h=h["catch"](function(){k.i=d;return 0<e?g.M(a,b,d,k.s).then(function(a){k.s=a;return g.fire("decrypt",k)}):g.fire("decrypt",k)}).then(function(){var a=k.B;if(!(a instanceof Uint8Array)||a.length!==c.length-g.F)throw Error("Decryption failed");return{B:a,i:k.i}})});h["catch"](function(){});return h},
$:function(a,b,c){var d=e(a,b);if(this.a.has(d)||this.g.has(d))return this.M(a,b,a,c);a=this.c.get(d);b=a[0];return this.N(b,a[1],b,c)},N:function(a,b,c,d){var e={b:a,f:b,i:c,R:d,S:null};a=this.fire("wrap",e).then(function(){var a=e.S;if(!(a instanceof Uint8Array)||a.length!==d.length)throw Error("Re-wrapping failed");return a});a["catch"](function(){});return a},M:function(a,b,c,d){var e={b:a,f:b,i:c,S:d,R:null};a=this.fire("unwrap",e).then(function(){var a=e.R;if(!(a instanceof Uint8Array)||a.length!==
d.length)throw Error("Re-wrapping failed");return a});a["catch"](function(){});return a}};p.prototype=Object.assign(Object.create(k.prototype),p.prototype);Object.defineProperty(p.prototype,"constructor",{enumerable:!1,value:p})}).call(this)},{"async-eventer":1}]},{},[2])(2)});